...
import com.myproject.PGIvirtualCare.service.EmailService;
...
//
	...
	public String Registration(@ModelAttribute("userDto") Users newUser, RedirectAttributes attributes) {
		...
		try {
			...
			String body = "Hello " + newUser.getName() + ",\n\n" + "Thank you for registering at PGI Virtual Care.\n\n"
					+ "Best regards,\nPGI Virtual Care Team";

			emailService.sendEmail(newUser.getEmail(), subject, body);

			attributes.addFlashAttribute("msg", "Registration Successful! Check your email.");
