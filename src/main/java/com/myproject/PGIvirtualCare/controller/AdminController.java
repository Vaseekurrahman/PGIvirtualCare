...
public class AdminController {
	...
	public String deleteDoctor(@RequestParam("id") long doctorId, HttpSession session) {

		// 1. Get all appointments for this doctor
		List<Appointment> appointments = appointmentRepository.findAllByDoctorId(doctorId);

		// 2. Delete all prescriptions related to these appointments
		for (Appointment ap : appointments) {
			prescriptionRepository.deleteByAppointmentId(ap.getId());
		}
